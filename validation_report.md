...
*   **Non-Natural Shapes (Furniture, Planes, Boxes):** Higher geo error rates (approx. 0.3) are expected. This is due to the sharp edges and non-smooth transitions characteristic of man-made objects, which can cause instability in spectral harmonic functions.

**Conclusion:** HST is a domain-specific solver intended for natural, deformable shapes where it outperforms general-purpose rigid registration methods.
